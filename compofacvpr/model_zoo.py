...
# from layers import *
from models.basic_layers import MyModule, ZeroLayer, MBInvertedConvLayer, IdentityLayer
from models.basic_layers import set_layer_from_config
...
def ofa_net(net_id, model_dir=None, pretrained=True):
    from compofaecg.models.dynamic_op import DynamicSeparableConv2d
    from compofaecg.models.cells_search.ofa_mbv3 import OFAMobileNetV3
    from compofaecg.models.cells_search.ofa_proxyless import OFAProxylessNASNets
    ...
    if net_id == 'ofa_proxyless_d234_e346_k357_w1.3':
        ...
        net = OFAMobileNetV3(
            bn_param=(0.1, 1e-5), dropout_rate=0, width_mult_list=1.0,
