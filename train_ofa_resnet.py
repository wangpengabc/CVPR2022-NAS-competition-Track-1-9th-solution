...
"""
# compound training
horovodrun -np 4 CUDA_VISIBLE_DEVICES=0,1,2,3 python train_ofa_net.py --task compound --phase 1 --fixed_kernel --heuristic simple

# train teacher network
horovodrun -np 8 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_ofa_resnet.py --task teacher --phase 1 --fixed_kernel --resume

CVPR track does not need variable kernel size.
# horovodrun -np 8 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_ofa_resnet.py --task kernel --resume
...
depth
phase 1:
horovodrun -np 8 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_ofa_resnet.py --task depth --phase 1 --fixed_kernel
teacher_path : runs/teacher/default/checkpoint/checkpoint.pth.tar
phase 2:
horovodrun -np 8 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_ofa_resnet.py --task depth --phase 2 --fixed_kernel
teacher_path : runs/teacher/default/checkpoint/checkpoint.pth.tar
 |
 |
\/
expand
phase 1:
horovodrun -np 8 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_ofa_resnet.py --task expand --phase 1 --fixed_kernel
horovodrun -np 7 CUDA_VISIBLE_DEVICES=1,2,3,4,5,6,7 python train_ofa_resnet.py --task expand --phase 1 --fixed_kernel
teacher_path : runs/teacher/default/checkpoint/checkpoint.pth.tar
phase 2:
horovodrun -np 8 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_ofa_resnet.py --task expand --phase 2 --fixed_kernel
teacher_path : runs/teacher/default/checkpoint/checkpoint.pth.tar
...
horovodrun -np 8 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_ofa_resnet.py --task compound --phase 1 --heuristic simple
horovodrun -np 8 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_ofa_resnet.py --task compound --phase 2 --heuristic simple
...
if __name__ == '__main__':
    ...
    if args.task == 'teacher':
        ...
        from compofacvpr.procedures.progressive_shrinking import supporting_elastic_depth_cvpr_resnet
        supporting_elastic_depth_cvpr_resnet(train, distributed_run_manager, args, validate_func_dict)
    elif args.task == 'expand':
        from compofacvpr.procedures.progressive_shrinking import supporting_elastic_expand_cvpr_resnet
        supporting_elastic_expand_cvpr_resnet(train, distributed_run_manager, args, validate_func_dict)
    elif args.task == 'compound':
        from compofacvpr.procedures.progressive_shrinking import supporting_compound
