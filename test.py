...
parser.add_argument('--task', type=str, default='compound', choices=[
...
parser.add_argument('--heuristic', type=str, default='simple', choices=['simple', 'none'])
...
if __name__ == '__main__':
    ...
    elif test_mode == "test_state_dict":
