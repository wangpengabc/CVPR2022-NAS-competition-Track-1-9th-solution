...
horovodrun -np 8 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_ofa_net.py --task teacher --phase 1 --resume
 |
 |
\/
horovodrun -np 8 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_ofa_net.py --task kernel --resume
teacher_path : runs/teacher/default/checkpoint/checkpoint.pth.tar
 |
 |
\/
horovodrun -np 8 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_ofa_net.py --task compound --phase 1 --heuristic simple
horovodrun -np 8 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_ofa_net.py --task compound --phase 2 --heuristic simple
...
args.teacher_path = "/home/sdc/wangpeng/NASHello/CompOFAECG/runs/default/teacher2kernel/checkpoint/checkpoint.pth.tar"
...
if __name__ == '__main__':
    ...
    if args.task == 'teacher':
        ...
        from compofacvpr.procedures.progressive_shrinking import supporting_elastic_depth
        supporting_elastic_depth(train, distributed_run_manager, args, validate_func_dict)
    elif args.task == 'expand':
        from compofacvpr.procedures.progressive_shrinking import supporting_elastic_expand
