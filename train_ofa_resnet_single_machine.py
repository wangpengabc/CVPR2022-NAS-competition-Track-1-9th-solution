...
"""
# compound training
CUDA_VISIBLE_DEVICES=0,1,2,3 python train_ofa_resnet_single_machine.py --task compound --phase 1 --fixed_kernel --heuristic simple

# train teacher network
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_ofa_resnet_single_machine.py --task teacher --phase 1 --fixed_kernel --resume

CVPR track does not need variable kernel size.
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_ofa_resnet_single_machine.py --task kernel --resume
...
teacher_path : runs/teacher/default/checkpoint/checkpoint.pth.tar
phase 2:
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_ofa_resnet_single_machine.py --task depth --phase 2 --fixed_kernel
teacher_path : runs/teacher/default/checkpoint/checkpoint.pth.tar
 |
 |
\/
...
CUDA_VISIBLE_DEVICES=1,2,3,4,5,6,7 python train_ofa_resnet_single_machine.py --task expand --phase 1 --fixed_kernel
teacher_path : runs/teacher/default/checkpoint/checkpoint.pth.tar
phase 2:
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_ofa_resnet_single_machine.py --task expand --phase 2 --fixed_kernel
teacher_path : runs/teacher/default/checkpoint/checkpoint.pth.tar



CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_ofa_resnet_single_machine.py --task compound --phase 1 --heuristic simple
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_ofa_resnet_single_machine.py --task compound --phase 2 --heuristic simple
...
from compofacvprsinglemachine.models.dynamic_op import DynamicSeparableConv2d
from compofacvprsinglemachine.models.cells_search.ofa_mbv3 import OFAMobileNetV3
from compofacvprsinglemachine.models.cells_search.ofa_resnet48 import OFAResNet48
from compofacvprsinglemachine.procedures.run_config_imagenet import ImagenetRunConfig
from compofacvprsinglemachine.procedures.run_manager import RunManager
from compofacvprsinglemachine.procedures.distributed_run_manager import DistributedRunManager
from compofacvprsinglemachine.datasets.base_provider import MyRandomResizedCrop
from compofacvprsinglemachine.utils import download_url
from compofacvprsinglemachine.procedures.progressive_shrinking import load_models
...
if __name__ == '__main__':
    ...
    # training
    from compofacvprsinglemachine.procedures.progressive_shrinking import validate, train
